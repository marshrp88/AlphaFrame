...
- Performance update: Further vendor splitting — now entry ~97KB (gzip ~24.9KB); separate chunks for `firebase` (~112KB gzip) and `plaid` (~31.8KB gzip); vendor ~415KB (gzip ~140KB). Treemap updated.
